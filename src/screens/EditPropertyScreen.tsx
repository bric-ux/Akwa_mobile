    ...
    try {
      ...
      if (propertyData) {
        ...
        setFormData({
          ...
          taxes: propertyData.taxes?.toString() || '0',
          ...
          is_monthly_rental: propertyData.is_monthly_rental || false,
          monthly_rent_price: propertyData.monthly_rent_price?.toString() || '',
      ...
      >
        ...
        <View style={styles.section}>
          ...
          {renderSwitchField(
            ...
            "Permettre au voyageur de payer 50% à la réservation et le reste à l'arrivée auprès de vous"
          )}
        </View>
