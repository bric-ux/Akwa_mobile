...
const MessagingScreen: React.FC = () => {
  ...
  const isInTabNavigator =
    route.name === 'MessagingTab' ||
    route.name === 'HostMessagingTab' ||
    route.name === 'VehicleOwnerMessagingTab' ||
    route.name === 'VehicleMessagingTab' ||
    route.name === 'MonthlyRentalMessagesTab' ||
    route.name === 'HotelMessagingTab' ||
    route.name === 'HotelManagerMessagingTab';
